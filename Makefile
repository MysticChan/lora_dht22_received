...
APP_OBJECTS = uart.rel led.rel timer.rel sx1278.rel main.rel

# STM8S Peripheral driver object files stm8s_tim4.rel  stm8s_spi.rel
PERIPH_OBJECTS = stm8s_gpio.rel stm8s_tim1.rel stm8s_clk.rel stm8s_uart2.rel stm8s_tim2.rel stm8s_spi.rel
...
OUTPUT_OBJECTS=Lora_Receiver.ihx
